...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-mcp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-mcp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-mcp
# for installing globally
pixi global install opentelemetry-instrumentation-mcp
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-mcp` available on your platform:
...
```
pixi search opentelemetry-instrumentation-mcp --channel conda-forge
```
